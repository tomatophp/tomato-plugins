        ...
        <div class="mx-auto">
            <x-splade-defer url="{{url('admin/plugins/api')}}">
                ...
                <div v-if="response.data" class="grid grid-cols-2 gap-4">
                    <div class="bg-white rounded-lg p-4 flex flex-col" v-for="(item, key) in response.data" :key="key">
                        ...
                        <div class="flex justifiy-center gap-1 my-4">
                            <x-tomato-admin-button warning type="icon" v-bind:href="'{{url('admin/plugins')}}/' + item.full_name + '/show'" :title="__('Show')">
