...
if((bool)config('tomato-plugins.active_ui')) {
    Route::middleware(['web', 'splade', 'verified'])->name('admin.')->group(function () {
        ...
        Route::get('admin/plugins/show', [\TomatoPHP\TomatoPlugins\Http\Controllers\PluginsController::class, 'show'])->name('plugins.show');
        Route::get('admin/plugins/api', [\TomatoPHP\TomatoPlugins\Http\Controllers\PluginsController::class, 'api'])->name('plugins.api');
        Route::get('admin/plugins/clear', [\TomatoPHP\TomatoPlugins\Http\Controllers\PluginsController::class, 'clear'])->name('plugins.clear');
...
//    Route::post('admin/plugins/upload', [\TomatoPHP\TomatoPlugins\Http\Controllers\PluginsController::class, 'store'])->name('plugins.store');
//    Route::post('admin/plugins/install', [\TomatoPHP\TomatoPlugins\Http\Controllers\PluginsController::class, 'install'])->name('plugins.install');
